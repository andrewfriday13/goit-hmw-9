...
const options = {
    ...
    onClose (selectedDates) {
        if (selectedDates[0] < Date.now()) {
            startTimer.disabled = true;
            (0, _notiflixDefault.default).Notify.failure("\u0431\u0435\u0440\u0438 \u0434\u0435\u0441\u044C \u0432 \u043C\u0430\u0439\u0431\u0443\u0442\u043D\u044C\u043E\u043C\u0443");
        } else startTimer.disabled = false;
...
function convertMs(ms) {
    ...
    const day1 = hour1 * 24;
    const days = addZero(Math.floor(ms / day1));
    const hours = addZero(Math.floor(ms % day1 / hour1));
    const minutes = addZero(Math.floor(ms % day1 % hour1 / minute1));
    const seconds = addZero(Math.floor(ms % day1 % hour1 % minute1 / second1));
    return {
        days,
        hours,
        minutes,
